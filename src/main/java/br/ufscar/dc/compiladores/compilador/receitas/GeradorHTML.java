...
public class GeradorHTML extends ReceitaBaseVisitor<Void> {
    ...
    // Construtor que inicializa o StringBuilder para armazenar o HTML
    public GeradorHTML() {
    ...
    // Visita o nó da receita e inicia a estrutura HTML
    @Override
    public Void visitReceita(ReceitaParser.ReceitaContext ctx) {
        ...
        // Adiciona estilo CSS para formatação da página
        html.append("<style>\n");
        ...
        // Adiciona o título e tempos de preparo e cozimento
        ...
        // Visita as seções de ingredientes e instruções
    ...
    // Visita a lista de ingredientes e gera o HTML correspondente
    @Override
    ...
    // Visita a lista de instruções e gera o HTML correspondente com checkboxes
    @Override
    ...
    // Formata o texto de um ingrediente (quantidade, unidade de medida e nome)
    ...
    // Formata o texto de uma instrução removendo o número inicial
